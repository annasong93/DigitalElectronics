...
1. Light control LED
Put a light sensor in to detect light. The led on the bracelet only light up when surrounding light is below certain darkness. Ohter wise it won't light up even it hear sounds.

2. Color
Led color is controled by vibration sensor. When the sensor detect more vibration the color will vary.
